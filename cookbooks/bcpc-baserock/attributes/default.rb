...
default['bcpc']['storage']['interface'] = 'eth0'
default['bcpc']['storage']['vlan_interface'] = 'eth0.10'
...
default['bcpc']['floating']['interface'] = 'eth0'
default['bcpc']['floating']['vlan_interface'] = 'eth0.127'
